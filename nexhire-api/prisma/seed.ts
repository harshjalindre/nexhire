...
async function main() {
  ...
  console.log("📧 Logins: admin@nexhire.com (SYSTEM), admin@mitpune.edu (MIT2024), rahul@mitpune.edu (MIT2024) / password123");
}
